...
<div class="profile-header position-relative text-white py-5"
    ...
    <div class="container position-relative d-flex flex-column flex-md-row justify-content-center align-items-center text-center py-4 gap-4">

        {{-- FOTO DE PERFIL --}}
        <div class="profile-image flex-shrink-0">
            <img src="{{ Auth::user()->avatar_url ?? asset('images/default-avatar.jpeg') }}"
                 alt="Avatar de {{ Auth::user()->nickname ?? Auth::user()->name }}"
