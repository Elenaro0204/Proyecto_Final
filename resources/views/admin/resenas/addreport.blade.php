<!-- resources/views/admin/resenas/addreport.blade.php -->
        ...
        <div class="max-w-3xl mx-auto relative rounded-xl overflow-hidden shadow-xl p-6">
            ...
            <div class="relative z-10 px-8 py-6">
                <div class="relative z-10 flex flex-col items-center text-center w-full">
                    <h2 class="text-2xl text-red-700 font-bold mb-3 uppercase">Reportar Reseña</h2>
                    ...
                    <form action="{{ route('admin.resenas.report.store', $review) }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" class="border p-2 w-full bg-gray-100" value="{{ $review->id }}"
                                disabled>
